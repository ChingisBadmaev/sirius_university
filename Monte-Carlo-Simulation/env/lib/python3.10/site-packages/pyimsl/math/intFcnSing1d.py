...
def intFcnSing1d(fcn, a, b, errAbs=None, errFrac=None, errRel=None, errPrior=None, maxEvals=None, singularity=None, nEvals=None, errEst=None, istatus=None):
    """ Integrates a function with a possible internal or endpoint singularity.
    """
    imslmath.imsl_d_int_fcn_sing_1d.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_int_fcn_sing_1d('
    ...
    if not (fcnWData is None):
        ...
        checkForDict(fcnWData,'fcnWData',['fcnWData','x','errPost','data'])
        evalstring +=','
        tmp_fcnWData_fcnWData_param = fcnWData['fcnWData']
        checkForCallable(tmp_fcnWData_fcnWData_param,'fcnWData')
        TMP_FCNWDATA_FCNWDATA=CFUNCTYPE(c_double,c_double,POINTER(c_double),POINTER(c_double))
