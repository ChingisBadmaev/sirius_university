...
def depreciationAmordegrc(cost, issue, firstPeriod, salvage, period, rate, basis):
    ...
    """
    imslmath.imsl_d_depreciation_amordegrc.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_depreciation_amordegrc('
