...
def cumulativePrincipal(rate, nPeriods, presentValue, start, end, when):
    """ Evaluates the cumulative principal paid between two periods.
    """
    imslmath.imsl_d_cumulative_principal.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_cumulative_principal('
