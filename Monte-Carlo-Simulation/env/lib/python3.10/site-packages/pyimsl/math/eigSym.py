...
def eigSym(a, vectors=None, range=None, aColDim=None, evecuColDim=None, returnNumber=None):
    """ Computes the eigenexpansion of a real symmetric matrix A.
    """
    imslmath.imsl_d_eig_sym.restype = POINTER(c_double)
    shape = []
    evalstring = 'imslmath.imsl_d_eig_sym('
    evalstring += 'c_int(n)'
    evalstring += ','
