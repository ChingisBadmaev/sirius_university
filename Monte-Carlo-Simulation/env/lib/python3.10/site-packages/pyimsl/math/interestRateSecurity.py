...
def interestRateSecurity(settlement, maturity, investment, redemption, basis):
    """ Evaluates the interest rate of a fully invested security.
    """
    imslmath.imsl_d_interest_rate_security.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_interest_rate_security('
    evalstring += 'settlement'
    evalstring += ','
    evalstring += 'maturity'
    evalstring += ','
    evalstring += 'c_double(investment)'
    evalstring += ','
    evalstring += 'c_double(redemption)'
    evalstring += ','
