...
def principalPayment(rate, period, nPeriods, presentValue, futureValue, when):
    """ Evaluates the payment on the principal for a specified period.
    """
    imslmath.imsl_d_principal_payment.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_principal_payment('
