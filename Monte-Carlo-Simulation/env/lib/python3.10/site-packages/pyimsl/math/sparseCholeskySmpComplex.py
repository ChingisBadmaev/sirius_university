...
from .mathStructs import Imsl_snodal_symbolic_factor
from .mathStructs import Imsl_c_numeric_factor
...
def sparseCholeskySmpComplex(a, b, returnSymbolicFactor=None, supplySymbolicFactor=None, symbolicFactorOnly=None, returnNumericFactor=None, supplyNumericFactor=None, numericFactorOnly=None, solveOnly=None, smallestDiagonalElement=None, largestDiagonalElement=None, numNonzerosInFactor=None, cscFormat=None, preordering=None):
    ...
    """
    imslmath.imsl_z_sparse_cholesky_smp.restype = POINTER(d_complex)
    shape = []
    evalstring = 'imslmath.imsl_z_sparse_cholesky_smp('
    evalstring += 'c_int(n)'
    evalstring += ','
    evalstring += 'c_int(nz)'
    evalstring += ','
    ...
    if not (returnSymbolicFactor is None):
        ...
        evalstring += ','
        returnSymbolicFactor_symFactor_tmp = (Imsl_snodal_symbolic_factor)()
    ...
    if not (returnNumericFactor is None):
        ...
        evalstring += ','
        returnNumericFactor_numFactor_tmp = (Imsl_c_numeric_factor)()
