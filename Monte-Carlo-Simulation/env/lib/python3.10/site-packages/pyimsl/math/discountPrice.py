...
def discountPrice(settlement, maturity, discountRate, redemption, basis):
    """ Evaluates the price of a security sold for less than its face value.
    """
    imslmath.imsl_d_discount_price.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_discount_price('
