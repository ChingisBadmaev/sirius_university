...
###########################################################################
from pyimsl.util.imslUtils import MATH, checkForBoolean, checkForList, checkForStr, fatalErrorCheck, loadimsl, toNumpyArray, toByte
...
def writeMatrix(title, a, transpose=None, aColDim=None, printAll=None,
    ...
    """
    imslmath.imsl_d_write_matrix.restype = None
    shape = []
    evalstring = 'imslmath.imsl_d_write_matrix('
