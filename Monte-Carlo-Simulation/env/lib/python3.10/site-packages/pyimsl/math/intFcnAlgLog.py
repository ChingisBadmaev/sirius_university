...
def intFcnAlgLog(fcn, a, b, weight, alpha, beta, errAbs=None, errRel=None, errEst=None, maxSubinter=None, nSubinter=None, nEvals=None, fcnWData=None):
    """ Integrates a function with algebraic-logarithmic singularities.
    """
    imslmath.imsl_d_int_fcn_alg_log.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_int_fcn_alg_log('
