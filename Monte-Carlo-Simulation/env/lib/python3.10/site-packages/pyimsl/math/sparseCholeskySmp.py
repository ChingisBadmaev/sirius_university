...
def sparseCholeskySmp(a, b, returnSymbolicFactor=None, supplySymbolicFactor=None, symbolicFactorOnly=None, returnNumericFactor=None, supplyNumericFactor=None, numericFactorOnly=None, solveOnly=None, smallestDiagonalElement=None, largestDiagonalElement=None, numNonzerosInFactor=None, cscFormat=None, preordering=None):
    ...
    """
    imslmath.imsl_d_sparse_cholesky_smp.restype = POINTER(c_double)
    shape = []
    evalstring = 'imslmath.imsl_d_sparse_cholesky_smp('
    evalstring += 'c_int(n)'
    evalstring += ','
    evalstring += 'c_int(nz)'
    evalstring += ','
    # a_tmp = POINTER(Imsl_d_sparse_elem)(Imsl_d_sparse_elem())
