...
def linSolPosdefCoordinate(a, b, returnSymbolicFactor=None, supplySymbolicFactor=None, symbolicFactorOnly=None, returnNumericFactor=None, supplyNumericFactor=None, numericFactorOnly=None, solveOnly=None, multifrontalFactorization=None, smallestDiagonalElement=None, largestDiagonalElement=None, numNonzerosInFactor=None, cscFormat=None):
    ...
    """
    imslmath.imsl_d_lin_sol_posdef_coordinate.restype = POINTER(c_double)
    shape = []
    evalstring = 'imslmath.imsl_d_lin_sol_posdef_coordinate('
    evalstring += 'c_int(n)'
    evalstring += ','
    evalstring += 'c_int(nz)'
    evalstring += ','
