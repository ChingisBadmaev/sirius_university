...
def priceMaturity(settlement, maturity, issue, rate, t_yield, basis):
    """ Evaluates the price, per $100 face value, of a  security that pays interest at maturity.
    """
    imslmath.imsl_d_price_maturity.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_price_maturity('
