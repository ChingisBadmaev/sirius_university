...
def linSolGen(a, b, transpose=None, factor=None, inverse=None, condition=None, factorOnly=None, solveOnly=None, inverseOnly=None):
    imslmath.imsl_d_lin_sol_gen.restype = POINTER(c_double)
    shape = []
    evalstring = 'imslmath.imsl_d_lin_sol_gen('
    evalstring += 'c_int(n)'
    evalstring += ','
