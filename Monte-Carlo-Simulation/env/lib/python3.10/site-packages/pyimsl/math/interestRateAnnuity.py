...
def interestRateAnnuity(nPeriods, payment, presentValue, futureValue, when, xguess=None, highest=None):
    """ Evaluates the interest rate per period of an annuity.
    """
    imslmath.imsl_d_interest_rate_annuity.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_interest_rate_annuity('
