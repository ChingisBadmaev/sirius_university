...
def pdeMethodOfLinesMgr(task, state, tol=None, hinit=None, initialValueDerivative=None, htrial=None, fcnUtWData=None, fcnBcWData=None):
    imslmath.imsl_d_pde_method_of_lines_mgr.restype = None
    shape = []
    evalstring = 'imslmath.imsl_d_pde_method_of_lines_mgr('
