...
def intFcnSing(fcn, a, b, errAbs=None, errRel=None, errEst=None, maxSubinter=None, nSubinter=None, nEvals=None, fcnWData=None):
    imslmath.imsl_d_int_fcn_sing.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_int_fcn_sing('
