...
def linProg(a, b, c, aColDim=None, upperLimit=None, constrType=None, lowerBound=None, upperBound=None, maxItn=None, obj=None, dual=None):
    imslmath.imsl_d_lin_prog.restype = POINTER(c_double)
    shape = []
    evalstring = 'imslmath.imsl_d_lin_prog('
    evalstring += 'c_int(m)'
    evalstring += ','
    evalstring += 'c_int(n)'
    evalstring += ','
