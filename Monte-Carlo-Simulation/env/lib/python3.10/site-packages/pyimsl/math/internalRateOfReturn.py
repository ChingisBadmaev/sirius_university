...
def internalRateOfReturn(values, xguess=None, highest=None):
    """ Evaluates the internal rate of return for a schedule of cash flows.
    """
    imslmath.imsl_d_internal_rate_of_return.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_internal_rate_of_return('
