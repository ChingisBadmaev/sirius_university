...
def bondEquivalentYield(settlement, maturity, discountRate):
    """ Evaluates the bond-equivalent yield of a Treasury bill.
    """
    imslmath.imsl_d_bond_equivalent_yield.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_bond_equivalent_yield('
