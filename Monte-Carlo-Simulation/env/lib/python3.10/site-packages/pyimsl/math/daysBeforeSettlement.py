...
def daysBeforeSettlement(settlement, maturity, frequency, basis):
    """ Evaluates the number of days starting with the beginning of the coupon period and ending with the settlement date.
    """
    imslmath.imsl_days_before_settlement.restype = c_int
    shape = []
    evalstring = 'imslmath.imsl_days_before_settlement('
