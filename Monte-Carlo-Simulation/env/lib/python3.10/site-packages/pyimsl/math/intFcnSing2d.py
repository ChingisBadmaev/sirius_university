...
def intFcnSing2d(fcn, a, b, gcn, hcn, gcnWData=None, hcnWData=None, errAbs=None, errFrac=None, errRel=None, errPrior=None, maxEvals=None, singularity=None, nEvals=None, errEst=None, istatus=None):
    """ Integrates a function of two variables with a possible internal or endpoint singularity.
    """
    imslmath.imsl_d_int_fcn_sing_2d.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_int_fcn_sing_2d('
    ...
    if not (fcnWData is None):
        ...
        checkForDict(fcnWData,'fcnWData',['fcnWData','x','y','errPost','data'])
        evalstring +=','
        tmp_fcnWData_fcnWData_param = fcnWData['fcnWData']
        checkForCallable(tmp_fcnWData_fcnWData_param,'fcnWData')
        TMP_FCNWDATA_FCNWDATA=CFUNCTYPE(c_double,c_double,c_double,POINTER(c_double),POINTER(c_double))
