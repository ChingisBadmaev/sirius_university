...
def modifiedDuration(settlement, maturity, couponRate, t_yield, frequency, basis):
    """ Evaluates the modified Macauley duration of a security.
    """
    imslmath.imsl_d_modified_duration.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_modified_duration('
