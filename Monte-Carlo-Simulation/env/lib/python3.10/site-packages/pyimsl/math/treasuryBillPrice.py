...
def treasuryBillPrice(settlement, maturity, discountRate):
    """ Evaluates the price per $100 face value of a Treasury bill.
    """
    imslmath.imsl_d_treasury_bill_price.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_treasury_bill_price('
