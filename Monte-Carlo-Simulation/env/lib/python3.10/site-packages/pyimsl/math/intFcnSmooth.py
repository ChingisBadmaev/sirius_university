...
from ctypes import CFUNCTYPE, POINTER, byref, c_double, c_void_p
...
def intFcnSmooth(fcn, a, b, errAbs=None, errRel=None, errEst=None, fcnWData=None):
    """ Integrates a smooth function using a nonadaptive rule.
    """
    imslmath.imsl_d_int_fcn_smooth.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_int_fcn_smooth('
    ...
    if not (fcnWData is None):
        ...
        evalstring += ','
        fcnWData_y_tmp = fcnWData['data']
        evalstring += 'c_double(fcnWData_y_tmp)'
        evalstring += ','
        fcnWData_data_tmp = fcnWData[3]
