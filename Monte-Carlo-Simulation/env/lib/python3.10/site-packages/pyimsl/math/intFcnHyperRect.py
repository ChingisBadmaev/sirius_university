...
def intFcnHyperRect(fcn, a, b, errAbs=None, errRel=None, errEst=None, maxEvals=None, fcnWData=None):
    imslmath.imsl_d_int_fcn_hyper_rect.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_int_fcn_hyper_rect('
