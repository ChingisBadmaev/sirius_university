...
def intFcnTrig(fcn, a, b, weight, omega, errAbs=None, errRel=None, errEst=None, maxSubinter=None, nSubinter=None, nEvals=None, maxMoments=None, fcnWData=None):
    """ Integrates a function containing a sine or a cosine factor.
    """
    imslmath.imsl_d_int_fcn_trig.restype = c_double
    shape = []
    evalstring = 'imslmath.imsl_d_int_fcn_trig('
