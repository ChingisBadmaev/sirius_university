...
def randomSubstreamSeedGet(iseed1):
    ...
    """
    imslstat.imsls_random_substream_seed_get.restype = c_int
    shape = []
    evalstring = 'imslstat.imsls_random_substream_seed_get('
    evalstring += 'c_int(iseed1)'
    evalstring += ')'
