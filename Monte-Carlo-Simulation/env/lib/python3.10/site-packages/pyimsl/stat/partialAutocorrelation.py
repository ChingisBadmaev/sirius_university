...
def partialAutocorrelation(lagmax, cf):
    """ Computes the sample partial autocorrelation function of a stationary time series.
    """
    imslstat.imsls_d_partial_autocorrelation.restype = POINTER(c_double)
    shape = []
    evalstring = 'imslstat.imsls_d_partial_autocorrelation('
    ...
    return processRet(result, shape=(lagmax), result=True)
