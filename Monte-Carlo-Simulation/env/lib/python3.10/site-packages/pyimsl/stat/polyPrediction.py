...
def polyPrediction(polyInfo, x, confidence=None, weights=None, scheffeCi=None, pointwiseCiPopMean=None, pointwiseCiNewSample=None, leverage=None, y=None, residual=None, standardizedResidual=None, deletedResidual=None, cooksd=None, dffits=None):
    """ Computes predicted values, confidence intervals, and diagnostics after fitting a polynomial regression model.
    """
    imslstat.imsls_d_poly_prediction.restype = POINTER(c_double)
    shape = []
    evalstring = 'imslstat.imsls_d_poly_prediction('
    evalstring += 'polyInfo'
    evalstring += ','
