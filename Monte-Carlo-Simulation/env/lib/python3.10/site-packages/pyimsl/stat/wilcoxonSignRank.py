...
def wilcoxonSignRank(x, fuzz=None, stat=None, nMissing=None):
    """ Performs a Wilcoxon signed rank test.
    """
    imslstat.imsls_d_wilcoxon_sign_rank.restype = POINTER(c_double)
    shape = []
    evalstring = 'imslstat.imsls_d_wilcoxon_sign_rank('
    ...
    if not (nMissing is None):
        ...
        evalstring += ','
        nMissing_nMissing_tmp = c_double()
