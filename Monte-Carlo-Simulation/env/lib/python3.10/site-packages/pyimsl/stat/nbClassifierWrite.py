...
def nbClassifierWrite(nbClassifier, filename, t_print=None, file=None):
    VersionFacade.checkVersion(7)
    imslstat.imsls_d_nb_classifier_write.restype = None
    shape = []
    evalstring = 'imslstat.imsls_d_nb_classifier_write('
